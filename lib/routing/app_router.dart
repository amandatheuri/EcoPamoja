import 'package:ecopamoja/admin/features/auth/admin_user_profile.dart';
...
GoRouter appRouter({required bool showOnboarding, required bool isLoggedIn}) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/user-profile',
        builder: (context, state) => const AdminUserProfile(),
      ),
    ],
  );
}
