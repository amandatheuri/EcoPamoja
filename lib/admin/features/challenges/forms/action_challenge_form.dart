...
class AddActionChallengeDialog extends StatefulWidget {
  ...
  @override
  State<AddActionChallengeDialog> createState() =>
      _AddActionChallengeDialogState();
}
...
class _AddActionChallengeDialogState extends State<AddActionChallengeDialog> {
  ...
  final List<String> _types = ['dailyHabits', 'wasteReduction'];
  ...
  Future<void> _submitForm() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('challenges').add({
        ...
        'type': _selectedType, // use dropdown value
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: AbsorbPointer(
                          child: _buildField(
                              'Due Date (pick date & time)', _dueDateController),
                        ),
                      ),
                      const SizedBox(height: 10),
                      _buildField(
